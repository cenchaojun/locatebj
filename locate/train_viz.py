...
parser.add_argument('--save_root', type=str, default='save_models_seen_viz')
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('/data2/cenchaojun/code/locate/locate/pretrain_weight/best_unseen.pth.tar'))
